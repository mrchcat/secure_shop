...
VALUES ('admin@mail.ru','Pavel Viktorovich','266cfbef-67c0-44d4-a1d1-f722cc7b9df0'),
       ('anna@mail.ru','Anna','db1673e9-bf97-4dfa-acdb-88a280d4d144'),
       ('boris@mail.ru','Boris','73c474e3-264f-4d8d-8f5d-4f566eb341a0');

INSERT INTO credentials (username,password,roles,enabled,user_id)
VALUES ('admin','$2a$10$ysnoG7SZdd5SOvrx8T/VGem08LYXe98dgX9sftowFhwvOjiLxVb7u','ROLE_ADMIN',true,1),
       ('anna1980','$2a$10$rwHqUeeYB7ytgp03RUCU5.3N3IsrIYsNBRIqjT0o22eVlbLPVFUpK','ROLE_USER',true,2),
       ('boris1980','$2a$10$ft81YDKh0iPzNzWr/Nex4uz/mK9zTBuqVtEF/ZwrURkS4gbBQTHO.','ROLE_USER',true,3);
...
INSERT INTO items(article_number, name,description,picture_path,price,unit)
VALUES ('61f0c404-5cb3-11e7-907b-a6006ad3dba0','Блендер Centek CT-1343 White 600Вт','Блендер Centek — ваш незаменимый помощник! Благодаря мощному двигателю и острым лезвиям, он легко измельчает фрукты, овощи, орехи и другие продукты. Не упустите возможность обновить свою кухню с блендером Centek! ','images/61f0c404-5cb3-11e7-907b-a6006ad3dba0.png',669,'PIECE');
